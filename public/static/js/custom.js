      ...
      $(".contactform").on("submit", function() {
          ...
          $.ajax({
              ...
              success: function(result) {
                  if (result === "success") {
					  $(".output_message").text("");
					  swal("Terimakasih", "Tim kami akan segera menghubungi Anda.", "success")
						  .then(function () {
						  	location.reload();
					  });
                      // $(".contactform").find(".output_message").addClass("success");
                      // $(".output_message").text("Permintaan Anda telah berhasil dikirim! Silahkan cek email Anda untuk langkah selanjutnya.");
                  } else {
					  $(".output_message").text("");
					  swal("Terimakasih", "Tim kami akan segera menghubungi Anda.", "success")
						  .then(function () {
